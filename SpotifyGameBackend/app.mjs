...
async function postData(url = "", data = {}) {    // Default options are marked with *
    const response = await fetch(url, {
        ...
        body: "grant_type=client_credentials&client_id=acaeb65eed5644c798b3ae8a3ef7cde2&client_secret=c8668ba1c0744c0c8857089d1d6bf6d2"
    });
...
app.get('/artist/songs/:id', (req, res) => {
    let links = ['https://p.scdn.co/mp3-preview/0a69f787920bde0a0e1d17af762695ad3cc9d99b?cid=acaeb65eed5644c798b3ae8a3ef7cde2'];
    res.json(links);
});
